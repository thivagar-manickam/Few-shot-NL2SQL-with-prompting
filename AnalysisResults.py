...
def get_accuracy(db_id,gold_sql,predicted_sql):
    ...
    cmd_str = ("python3 test-suite-sql-eval-master/evaluation.py --gold test-suite-sql-eval-master/Gold_test.txt "
               "--pred test-suite-sql-eval-master/Predicted_test.txt "
               "--db test-suite-sql-eval-master/database/ --etype exec ")
